...
/** The real brand mark: white glyph on WhatsApp green (#25D366), NOT
 *  `currentColor` like every other icon in this file. Two reasons it is the
 *  exception. A logo in the wrong colour reads as a knock-off, and this one is
 *  a promise about where the link goes. And the badge is what makes the row
 *  legible at a glance — a monochrome outline at this size is just a speech
 *  bubble. Fixed colours in both themes, same reasoning as the QR plate.
 *
 *  The 32-unit box is the badge; the 24-unit glyph is centred inside it at
 *  21/24 scale, hence translate(5.5) with (32 - 21) / 2 = 5.5. */
...
export function WarningTriangleIcon({ size = 14 }: { size?: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export function CloudDownIcon({ size = 13 }: { size?: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
/** A wrench — "something here is broken and can be put right". */
export function WrenchIcon({ size = 12 }: { size?: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
export function ClipboardIcon({ size = 14 }: { size?: number }) {
  return (
    <svg viewBox="0 0 24 24" width={size} height={size} fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round">
