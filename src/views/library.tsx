...
import { exportCards, exportCardsCSV, exportCardsTXT, cardPackageText } from '../services/importExport';
...
function showExportModal(cards: Card[], user: AppState): void {
  ...
  const renderRoot = () => {
    ...
    body.appendChild(mkChoice(iconTxt, 'TXT', t('library.export.txtDesc'), 'var(--color-muted)', () => { close(); exportCardsTXT(cards, user); }));
  };
